...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        // Seed demo users
        User u1 = new User("Arjun Sharma", "arjun.sharma@srmap.edu.in", passwordEncoder.encode("password123"));
        User u2 = new User("Priya Reddy", "priya.reddy@srmap.edu.in", passwordEncoder.encode("password123"));
        ...
        i1.setDescription("Lost a blue HP laptop bag near the library. Has my charger and notes inside. Very important!");
        ...
        i2.setContactInfo("priya.reddy@srmap.edu.in");
        i2.setReportedBy(u2);
        ...
        i3.setContactInfo("priya.reddy@srmap.edu.in");
        i3.setReportedBy(u2);
        ...
        i4.setContactInfo("arjun.sharma@srmap.edu.in");
        i4.setReportedBy(u1);
        itemRepository.save(i4);

        Item i5 = new Item();
        i5.setTitle("Prescription Glasses");
        i5.setDescription("Lost my spectacles (rectangular frame, -2.5 power) in the seminar hall during the guest lecture.");
        ...
        i5.setContactInfo("arjun.sharma@srmap.edu.in / 9876543210");
        i5.setReportedBy(u1);
        ...
        i6.setContactInfo("priya.reddy@srmap.edu.in");
        i6.setReportedBy(u2);
        itemRepository.save(i6);

        System.out.println("✅ Demo data seeded successfully!");
        System.out.println("   Demo accounts: arjun.sharma@srmap.edu.in / password123");
        System.out.println("                  priya.reddy@srmap.edu.in / password123");
    }
}
